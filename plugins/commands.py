...
async def start(client, message):
    ...
    files = files_[0]
    title = '@Thenameisravan ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), files.file_name.split()))
