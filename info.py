...
BOT_TOKEN = environ.get('BOT_TOKEN', "6863538152:AAHSCr7-kuMRqJdQ9Qf2NTmEkGAClaNRL20")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://telegra.ph/file/57442b4072ef62675e979.jpg https://telegra.ph/file/594e6082102f9075ba456.jpg')).split()
NOR_IMG = environ.get("NOR_IMG", "https://telegra.ph/file/11f7bb889cc949db28786.jpg")
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '763351261').split()]
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002197302739'))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://a2blinks99:Samael@samaelxbot.77wiky2.mongodb.net/?retryWrites=true&w=majority")
...
STREAM_URL = environ.get("STREAM_URL", "linear-darcie-thenameisravan-33c47006.koyeb.app/") # https://example.com/ (Your Stream Url)
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+aHR0iy2NeF8zZDNi')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Movieshubfree4You')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/A2BTutorial')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002122029906'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Moviesfree4you_support')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002028203451')).split()]
MELCOW_NEW_USERS = is_enabled((environ.get('MELCOW_NEW_USERS', "False")), False)
PROTECT_CONTENT = is_enabled((environ.get('PROTECT_CONTENT', "False")), False)
PUBLIC_FILE_STORE = is_enabled((environ.get('PUBLIC_FILE_STORE', "True")), True)

#MOVIE UPDATE
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-100219730273'))
